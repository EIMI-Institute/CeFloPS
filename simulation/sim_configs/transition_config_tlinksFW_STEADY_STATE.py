...
class DefStateMachine(AbstractStateMachine):
    ...
    def p_resolve_link_chances(self, links, simulation=None):
        return transition_functions.p_link_chances_q(
            links, simulation=simulation
        )
    ...
    def p_substate(self, cell, simulation, time_taken) -> (list, list):
        ...
        """
        return transition_functions.p_substate_no_change_until(
            cell, simulation, time_taken, 350
        )
